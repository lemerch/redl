...
if (line.compare(rms, 3, "INT") == 0) {
	...
	if(stw == false && stq == false) {
		...
		if(GLOBAL_array == true) {
			...
			noest = "vector<long long>" + GLOBAL;
		}else {
			noest = "long long " + GLOBAL;
		}
